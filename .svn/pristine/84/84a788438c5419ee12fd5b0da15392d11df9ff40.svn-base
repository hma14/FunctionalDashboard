...
truncate table [dbo].[CategoryIDList];
go
...
INSERT [dbo].[CategoryIDList] ([CategoryName], [CategoryID]) VALUES (N'RemediationWebService', 52)
INSERT [dbo].[CategoryIDList] ([CategoryName], [CategoryID]) VALUES (N'RemediationTask', 53)
go
truncate table [dbo].[EventIDList]
go
